...
########### Plots tab #################################
# =============================================================================
col1=[      [sg.Text('Figure 1: Lband and Rband as function of pressure')],
            [sg.Canvas(key='-CANVAS1-',size=(200 * 2, 200))],
            [sg.Canvas(key='controls_cv1')],
            [sg.Text('Figure 3: Shear modulus plot')],
            [sg.Canvas(key='-CANVAS3-',size=(200 * 2, 200))],
            [sg.Canvas(key='controls_cv3')],
        ]
col2=[      [sg.Text('Figure 2: Volume as a function of pressure')],
            [sg.Canvas(key='-CANVAS2-',size=(200 * 2, 200))],
            [sg.Canvas(key='controls_cv2')],
            [sg.Text('Figure 4: Compression modulus plot')],
...
######### ALL THE PLOTS #################
    if event == '-Graphbutton-':    #OK button in plotting tab
        ...
        data = pd.read_csv("txtfile/test3.txt",header=0,delim_whitespace=True)
        print(data)
        print(data.shape)
